...
#define EDIT_IMAGE_SELECT_HEIGH				(MAIN_WINDOW_HEIGH - EDIT_IMAGE_SELECT_Y * 4)
#define	EDIT_IMAGE_SELECT_STYLE				(WS_CHILD | WS_VISIBLE | WS_BORDER | BS_RIGHT | ES_MULTILINE | ES_AUTOHSCROLL | ES_AUTOVSCROLL | ES_WANTRETURN)
/*
...
#define	STATIC_LAB_MULTICAST_IP_STYLE		(WS_CHILD | WS_VISIBLE  | BS_FLAT | ES_MULTILINE | ES_AUTOHSCROLL | ES_AUTOVSCROLL)
